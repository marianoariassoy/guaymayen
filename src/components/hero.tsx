...
const hero = () => {
  ...
  return (
    <section className="h-screen w-screen overflow-hidden" id="hero">
      <div className="pointer-events-none absolute inset-0 bg-linear-to-b from-black/60 to-transparent h-50 w-screen z-20" />
      ...
      <div className="slide-container">
        ...
        >
          <div className="h-screen w-screen relative overflow-hidden fade-in">
            <div
              style={{
                ...divStyle,
          ...
          <div className="h-screen w-screen relative overflow-hidden fade-in">
            <div
              style={{
                ...divStyle,
                backgroundImage: `url(${slideImages[1].url})`,
              }}
              className="h-full w-full px-4 bg-center bg-cover bg-no-repeat"
            >
              <div className="flex flex-col gap-y-2 text-center max-w-4xl mx-auto fade-in delay-200 px-18">
                ...
                <div
                  className="flex w-fill mt-2 justify-center items-center"
      ...
      <div className="hidden lg:block absolute translate-y-14 bottom-0 left-0 w-full overflow-hidden leading-none animate-fade-up z-30">
        <div className="relative w-[200%] animate-wave translate-y-4  text-white">
          <svg
