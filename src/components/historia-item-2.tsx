const HistoriaItem1 = () => {
  return (
    <article className="w-full h-screen py-16 bg-linear-to-b from-black from-0% via-browndark2 via-30% to-browndark2 to-100% relative px-4">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl m-auto z-40 text-foreground text-center shadow-xl px-14 lg:px-4">
