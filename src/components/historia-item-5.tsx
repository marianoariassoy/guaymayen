const HistoriaItem1 = () => {
  return (
    <article className="w-full h-full relative flex justify-center bg-linear-to-b from-black from-0% via-browndark2 via-30% to-browndark2 to-100%">
      <div className="w-full max-w-5xl mx-auto px-4 flex flex-col-reverse lg:flex-row items-center justify-center gap-x-10 gap-y-8">
        <div className="lg:w-1/2 flex flex-col gap-y-8 py-12">
          <h1 className="font-display text-2xl lg:text-4xl font-black  text-center z-40">
            Datos que sorprenden
          </h1>
          <div className="flex flex-col gap-y-4 relative">
            <article className="flex flex-col px-10 py-6 rounded-3xl border border-white text-center">
        ...
        <div className="lg:w-1/2 relative">
          ...
          <div className="w-full mt-30 max-w-2xl m-auto flex flex-col text-white text-center z-40 text-lg lg:text-2xl">
